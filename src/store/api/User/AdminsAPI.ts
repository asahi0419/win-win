...
export const createAdminAPI = async (params: IAdminData) => axios.post(`${REQUEST_API_URL}/${PREFIX}/create`, params)
...
export const deleteAdminAPI = async (id: string) => axios.delete(`${REQUEST_API_URL}/${PREFIX}/${id}`)
